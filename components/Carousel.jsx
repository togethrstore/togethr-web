...
const CarouselItem = ({ imageUrl, category, name, title, location, stars }) => {
  return (
    <div
    ...
    >
      <div className="flex h-full flex-col justify-between">
        <div className="w-max bg-[#625DF5] px-4 py-2 gap-x-2 flex items-center rounded-full">
          ...
          <div className="text-white text-lg medium">{category}</div>
        </div>
        <div className="flex flex-col gap-y-3">
          <div className="text-2xl bold text-white">{name}</div>
          <div className="text-[#E6E6E6] text-lg medium">{title}</div>
          <div className="flex justify-between items-center">
            <div className="flex gap-x-1 items-center">
              <div className="w-4">
                <Image src={Location} alt="" />
              </div>
              <div className="text-[#E6E6E6] text-base medium">{location}</div>
            </div>
            <div className="flex gap-x-1 items-center">
              <div className="w-4">
                <Image src={Star} alt="" />
              </div>
              <div className="text-[#E6E6E6] text-base medium">{stars}</div>
            </div>
          </div>
        </div>
      </div>
